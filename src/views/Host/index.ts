...
import WithRender from './host.html?style=./host.scss';
...
@WithRender
@Component({
  components: { Card, PieChart: PieChartWithLegend, ProgressBarGroup: RowProgressBarGroup, vLegend: Legend, Top5, NoProblem }
})
